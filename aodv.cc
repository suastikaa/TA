...
AodvExample::CreateNodes ()
{
  ...
  mobility.SetMobilityModel ("ns3::ConstantPositionMobilityModel", "Model", StringValue ("Time"), "Time", StringValue ("2s"), "Speed", StringValue ("ns3::UniformRandomVariable[Min=0.0|Max=3.0]"), "Direction", StringValue ("ns3::UniformRandomVariable[Min=0.0|Max=6.0]"), "Bounds", RectangleValue (Rectangle (-100, 100, -100, 100))); 
